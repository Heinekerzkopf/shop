	...
	<body>
					...
					<div class="row justify-content-between">
						<div class="col">
							<a href="tel:5551234567">
								<span class="icon-phone">&#9743;</span> 420 123 456 789
							</a>
						</div>
						<div class="col text-end icons">
							...
							<div class="dropdown d-inline-block">
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Přihlásit se</a></li>
									<li><a class="dropdown-item" href="#">Registrace</a></li>
								</ul>
							</div>
						...
						<div class="container-fluid p-0">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
									<li class="nav-item">
										<a class="nav-link" href="category.html">Počítače</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="category.html">Tablety</a>
									</li>
									...
									<li class="nav-item">
										<a class="nav-link" href="category.html">Mobily</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="category.html">Fotoaparáty</a>
									</li>
								</ul>
							</div>
		...
		<section class="services">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<h3 class="section-title">Výhody které získate s námi</h3>
					</div>
					...
					<div class="row">
						<div class="col-md-3 col-6">
							...
							<ul class="list-unstyled">
								...
								<li><a href="#">Platba a doručení</a></li>
								<li><a href="#">Kontakty</a></li>
							</ul>
						</div>

						<div class="col-md-3 col-6">
							<h4>Otevíraci doba</h4>
							<ul class="list-unstyled">
								<li>Ulice, Město</li>
								<li>PO-NE: 9:00 - 18:00</li>
								<li>Non-stop</li>
							</ul>
						</div>
